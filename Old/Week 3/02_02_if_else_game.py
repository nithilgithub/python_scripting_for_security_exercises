...
if name[0] in "aeiou":
    print(f"Aha! Oho! Uhu! Ihi! {name}, your name begins with a vowel!")
else:
    print(f"Hey {name}, nice consonant-starting name you've got there!")
...
if number == random_number:
    ...
    print(f"Sorry, you guessed wrong. The right number was {random_number}.")
